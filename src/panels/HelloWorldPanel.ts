...
export class HelloWorldPanel {
  ...
  private _getWebviewContent(webview: Webview, extensionUri: Uri) {
    const mainUri = getUri(webview, extensionUri, ["dist", "webview.js"]);

    // Tip: Install the lit-html VS Code extension to enable code highlighting below
    return html`
      <!DOCTYPE html>
      <html lang="en">
        <head>
        ...
        <body>
          <h1>Hello World!</h1>
          <vscode-button id="howdy">Hey there</vscode-button>
        </body>
      </html>
    `;
  }
